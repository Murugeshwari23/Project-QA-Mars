...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("\"gh&*i\"", "Fluent", null)]
...
#line hidden
#line 9
 testRunner.When("Navigate to language tab in the profile page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
 testRunner.And(string.Format("Add new \'{0}\' and \'{1}\' to the language list", language, level), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 11
 testRunner.Then(string.Format("New details \'{0}\' and \'{1}\' are added successfully", language, level), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
        ...
        [NUnit.Framework.TestCaseAttribute("$@67", "", null)]
...
#line hidden
#line 24
 testRunner.And(string.Format("Update \'{0}\' and \'{1}\' on an existing language record", language, level), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 25
...
#line hidden
#line 38
 testRunner.And(string.Format("Delete the record \'{0}\' and \'{1}\' from the language list", language, level), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 39
